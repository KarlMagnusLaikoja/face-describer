...
class FacialHairDescriber:
    ...
    def describeFacialHair(self, coordinates):
        ...
        return self.describeFacialHairThickness(pixels, facialHairPixels), facialHairPixels #Return the list of facial hair pixels so we can find the colour later
